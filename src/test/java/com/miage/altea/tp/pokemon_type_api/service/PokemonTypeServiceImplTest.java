...
*/
    @Test
    void pokemonTypeRepository_shouldBeTranslated_whenFindById(){
        var pokemonTypeService = new PokemonTypeServiceImpl();
...
*/
    @Test
    void pokemonTypeRepository_shouldBeTranslated_usingLocalResolver(){
        ...
        LocaleContextHolder.setLocale(Locale.FRENCH);
        for (PokemonType pt : pokemonTypeRepository.findAllPokemonType()) {
            verify(translationRepository).getPokemonName(pokemonTypeRepository.findPokemonTypeById(pt.getId()).getId(), Locale.FRENCH);
        }
        }
